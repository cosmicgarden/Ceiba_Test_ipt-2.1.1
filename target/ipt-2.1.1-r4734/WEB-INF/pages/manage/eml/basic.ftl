...
<div class="">
    ...
    <p><@s.text name="manage.metadata.basic.required.message" /></p>
  	...
  	<@text name="eml.description" help="i18n" requiredField=true />
    ...
    <@select name="resource.subtype" i18nkey="resource.subtype" help="i18n" options=listSubtypes value="${resource.subtype!''}" />
  	...
  	<div class="basicMetadata grid_17 suffix_1">
    	...
    	<div class="halfcolumn">
    	  	<@input name="eml.contact.firstName" help="i18n" />
    	</div>
      	<div class="halfcolumn">
    	  	<@input name="eml.contact.lastName" help="i18n" requiredField=true />
      	</div>
      	<div class="halfcolumn">
      		<@input name="eml.contact.position" help="i18n" requiredField=true />
    	</div>
      	<div class="halfcolumn">
      		<@input name="eml.contact.organisation" help="i18n" requiredField=true />
      	</div>
      	<div class="halfcolumn">
      		<@input name="eml.contact.address.address" help="i18n" />
    	</div>
      	<div class="halfcolumn">
      		<@input name="eml.contact.address.city" help="i18n" />
      	</div>
      	<div class="halfcolumn">
      		<@input name="eml.contact.address.province" help="i18n" />
    	</div>
      	...
      	<div class="halfcolumn">
      		<@input name="eml.contact.address.postalCode" help="i18n" />
    	</div>
      	<div class="halfcolumn">
      		<@input name="eml.contact.phone" help="i18n" />
      	</div>
    	<div class="halfcolumn">
    	  	<@input name="eml.contact.email" help="i18n" />
    	</div>
      	<div class="halfcolumn">
    	  	<@input name="eml.contact.homepage" help="i18n" />
      	</div>
  	</div>
	...
	<div class="basicMetadata grid_17 suffix_1">
      	...
      	<div class="halfcolumn">
    		<@input name="eml.resourceCreator.firstName" help="i18n" />
    	</div>
      	<div class="halfcolumn">
    		<@input name="eml.resourceCreator.lastName" help="i18n" requiredField=true />
    	</div>
      	<div class="halfcolumn">
    		<@input name="eml.resourceCreator.position" help="i18n" requiredField=true />
    	</div>
      	<div class="halfcolumn">
    		<@input name="eml.resourceCreator.organisation" help="i18n" requiredField=true />
    	</div>
      	<div class="halfcolumn">
    		<@input name="eml.resourceCreator.address.address" help="i18n" />
    	</div>
      	<div class="halfcolumn">
    		<@input name="eml.resourceCreator.address.city" help="i18n" />
    	</div>
      	<div class="halfcolumn">
    		<@input name="eml.resourceCreator.address.province" help="i18n" />
    	</div>
      	<div class="halfcolumn countryList">
    		<@select name="eml.resourceCreator.address.country" help="i18n" options=countries value="${eml.getResourceCreator().address.country!}"/>
    	</div>
      	<div class="halfcolumn">
    		<@input name="eml.resourceCreator.address.postalCode" help="i18n" />
    	</div>
      	<div class="halfcolumn">
    		<@input name="eml.resourceCreator.phone" help="i18n" />
    	</div>
      	<div class="halfcolumn">
    		<@input name="eml.resourceCreator.email" help="i18n" />
    	</div>
      	<div class="halfcolumn">
    		<@input name="eml.resourceCreator.homepage" help="i18n" />
    	</div>
  	</div>
	...
	<div class="basicMetadata grid_17 suffix_1">
      	...
      	<div class="halfcolumn">
    		<@input name="eml.metadataProvider.firstName" help="i18n" />
    	</div>
      	<div class="halfcolumn">
    		<@input name="eml.metadataProvider.lastName" help="i18n" requiredField=true />
    	</div>
    	<div class="halfcolumn">
    		<@input name="eml.metadataProvider.position" help="i18n" requiredField=true />
    	</div>
      	<div class="halfcolumn">
    		<@input name="eml.metadataProvider.organisation" help="i18n" requiredField=true />
    	</div>
    	<div class="halfcolumn">
    		<@input name="eml.metadataProvider.address.address" help="i18n" />
    	</div>
      	<div class="halfcolumn">
    		<@input name="eml.metadataProvider.address.city" help="i18n" />
    	</div>
    	<div class="halfcolumn">
    		<@input name="eml.metadataProvider.address.province" help="i18n" />
    	</div>
      	<div class="halfcolumn countryList">
    		<@select name="eml.metadataProvider.address.country" help="i18n" options=countries value="${eml.metadataProvider.address.country!}"/>
    	</div>
    	<div class="halfcolumn">
    		<@input name="eml.metadataProvider.address.postalCode" help="i18n" />
    	</div>
      	<div class="halfcolumn">
    		<@input name="eml.metadataProvider.phone" help="i18n" />
    	</div>
    	<div class="halfcolumn">
    		<@input name="eml.metadataProvider.email" help="i18n" />
    	</div>
      	<div class="halfcolumn">
    		<@input name="eml.metadataProvider.homepage" help="i18n" />
    	</div>
    </div>
