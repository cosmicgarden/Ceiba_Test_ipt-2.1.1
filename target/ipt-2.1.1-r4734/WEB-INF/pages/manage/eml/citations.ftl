...
<div id="baseItem" class="item" style="display:none;">
	<div class="right">
		...
		<@input name="identifier" i18nkey="eml.bibliographicCitationSet.bibliographicCitations.identifier" help="i18n" />
		<@text name="citation" i18nkey="eml.bibliographicCitationSet.bibliographicCitations.citation"  value="" size=40 help="i18n" requiredField=true />
</div>
