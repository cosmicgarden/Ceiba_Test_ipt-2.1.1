...
$(document).ready(function(){
	...
	function copyDetails(event) {
		...
		$("#item-"+index+" [id$='firstName']").attr("value", "");
		$("#item-"+index+" [id$='lastName']").attr("value", "Infraestructura Institucional de Datos");
		$("#item-"+index+" [id$='position']").attr("value", "");
		$("#item-"+index+" [id$='organisation']").attr("value", "Instituto de Investigaci\u00f3n de Recursos Biol\u00f3gicos Alexander Von Humboldt");
		$("#item-"+index+" [id$='address']").attr("value", "Calle 28A No. 15-09");
		$("#item-"+index+" [id$='city']").attr("value", "Bogot\u00e1, D.C.");
		$("#item-"+index+" [id$='province']").attr("value", "Bogot\u00e1, D.C.");
		$("#item-"+index+" [id$='postalCode']").attr("value", "");
		$("#item-"+index+" [id$='country']").attr("value", "COLOMBIA");
		$("#item-"+index+" [id$='phone']").attr("value", "3202767");
		$("#item-"+index+" [id$='email']").attr("value", "i2d@humboldt.org.co");
		$("#item-"+index+" [id$='homepage']").attr("value", "http://www.humboldt.org.co");		
	}
